...
export const Icons = {
  ...
  focus: (props: IconProps) => <IconBase {...props}><circle cx="12" cy="12" r="3" /><path d="M12 3v3M12 18v3M3 12h3M18 12h3" /></IconBase>,
  image: (props: IconProps) => <IconBase {...props}><rect x="3" y="4" width="18" height="16" rx="2" /><circle cx="8.5" cy="9.5" r="1.7" /><path d="m21 16-5.5-5.5a2 2 0 0 0-2.8 0L4 19" /></IconBase>,
  group: (props: IconProps) => <IconBase {...props}><rect x="3" y="3" width="9" height="9" rx="2" /><rect x="12" y="12" width="9" height="9" rx="2" /></IconBase>,
  ungroup: (props: IconProps) => <IconBase {...props}><rect x="3" y="3" width="8" height="8" rx="2" /><rect x="13" y="13" width="8" height="8" rx="2" /><path d="M11 7h2M7 11v2M17 13v-2M13 17h2" strokeDasharray="1.5 2" /></IconBase>,
};
