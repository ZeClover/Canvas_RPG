# RPG World Canvas — v0.6.0 (Fase 6)
...
## Módulos por campanha alcançam todas as Fases 2–6

**Toda** ferramenta especializada — não só a de uma fase específica — é um módulo que cada campanha liga ou desliga em `Ferramentas → Módulos desta campanha`. Ver a seção "Módulos" acima para como isso funciona; o painel lista 18 módulos agrupados por fase (2 a 6).
...
```bash
npm test           # 104 testes automatizados (Vitest) — inclui IndexedDB real via fake-indexeddb
