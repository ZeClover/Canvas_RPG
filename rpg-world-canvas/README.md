...
- 32 tipos de card (31 tipos de conteúdo + grupo), cada um com ícone, cor padrão e tamanho padrão configuráveis;
...
## Fase 10: um recurso de mesa, uma peça pessoal de personagem, e um atalho de leitura

- **Safety Tools**: `ModuleKey` campaign-level (mesmo formato do Calendar Engine): limites que nunca entram na história e cuidados que pedem fade to black, combinados antes ou durante a campanha, mais um histórico de ajustes feitos em sessão. Nada disso é imposto pelo app — nunca houve geração de conteúdo pra filtrar; é só o lugar de escrever o que foi combinado e lembrar como algo foi tratado.
...
- Criar um elemento por duplo clique sempre cria um NPC por padrão (não há como perguntar "qual tipo?" num duplo clique); use o seletor de tipo na barra de ferramentas do canvas para os outros 30 tipos.
