...
title Compilar RPG World Canvas v0.10.0
cd /d "%~dp0"

echo ===============================================================
echo  RPG World Canvas - build para Windows
echo ===============================================================
echo.
...
rem    o build, mas o usuario final precisa dele). E onde o
rem    IndexedDB do app vive de verdade dentro do executavel.
rem ---------------------------------------------------------------
...
echo   %cd%\src-tauri\target\release\bundle\nsis\RPG World Canvas_0.10.0_x64-setup.exe
echo.
echo Instalador MSI:
echo   %cd%\src-tauri\target\release\bundle\msi\RPG World Canvas_0.10.0_x64_en-US.msi
echo.
pause
exit /b 0
